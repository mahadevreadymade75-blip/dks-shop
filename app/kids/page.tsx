    ...
    <main className="bg-gradient-to-b from-sky-50 via-white to-pink-50 text-gray-900">
      ...
      {boysProducts.length > 0 && (
        <section className="py-16 px-6">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold mb-8">👦 Boys Items</h2>
      ...
      {girlsProducts.length > 0 && (
        <section className="py-16 px-6 bg-pink-50">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold mb-8">👧 Girls Items</h2>
      ...
      <section className="py-20 text-center">
        ...
        <p className="text-gray-600 mb-8">Order easily via WhatsApp</p>
      </section>
    </main>
  );
}
