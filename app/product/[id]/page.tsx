            ...
            <button
              onClick={() => {
                if (product.sizes && !selectedSize) {
                  alert(
                    "Please select product size and add to cart before ordering.",
                  );
                  return;
                }
                ...
                alert(
                  "Product added to cart. Please proceed to cart to complete the order.",
                );
              }}
              className="px-8 py-3 rounded-full border border-gray-400 hover:bg-gray-100 transition"
            >
              Order on WhatsApp
            </button>
          </div>
